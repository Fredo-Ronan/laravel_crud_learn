                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <img src="{{ asset($item->movie->image) }}" alt="" width="150px">
                                        </td>
                                        <td class="text-center">{{$item->movie->title }}</td>
                                        <td class="text-center">{{$item->class }}</td>
                                        <td class="text-center">{{$item->price }}</td>
                                        <td class="text-center">
                                            <form onsubmit="alert('Apakah Anda Yakin ingin menghapus data ini ?');" action="{{ route('ticket.destroy', $item->id) }}" method="POST">
